...
const RollingCircle = ({ containerRef }: RollingCircleProps) => {
	...
	return (
		<motion.div className="pointer-events-none absolute bottom-0 left-0 z-50" style={{ x }}>
			<motion.div
				className="h-12 w-12 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 shadow-lg"
				style={{
					rotate: rotation,
					boxShadow: "0 0 20px rgba(99, 102, 241, 0.6), 0 0 40px rgba(147, 51, 234, 0.3)",
				}}
			>
