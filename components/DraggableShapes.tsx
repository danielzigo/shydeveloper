...
const DraggableShapes: React.FC<{
	...
	return (
		<div className="relative flex h-[300px] w-full items-center justify-center xl:w-[500px]">
			{/* First Square - larger */}
			<motion.div
				className="absolute left-1/4 top-1/4 h-40 w-40 cursor-pointer bg-gradient-to-r from-blue-500 to-purple-600 shadow-lg"
				style={{
			...
			<motion.div
				className="absolute right-1/3 top-1/3 h-28 w-28 cursor-pointer bg-gradient-to-r from-green-500 to-teal-600 shadow-md"
				style={{
					cursor: isDragging ? "grabbing" : "grab",
				}}
				drag
			...
			{/* Hexagon Shape */}
			<motion.div
				className="absolute left-0 top-1/4 h-36 w-36 bg-gradient-to-r from-green-500 to-teal-600"
				style={{
